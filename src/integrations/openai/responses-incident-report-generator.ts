...
Use claim statements only for narrative facts and cite exact claim IDs. Use timeline events only in the timeline section and cite exact timeline event IDs.
