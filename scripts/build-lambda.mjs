...
await build({
  ...
  entryPoints: {
    ...
    'slack-installation-disconnect-main':
      'src/lambda/slack-installation-disconnect-main.ts',
...
const expectedBundleFiles = [
  ...
  'slack-installation-disconnect-main.js',
